				...
				<div id="rev_slider_wrapper" class="rev_slider_wrapper fullwidthbanner-container" style="margin:0px auto;background-color:#111111;padding:0px;margin-top:0px;margin-bottom:0px;background-repeat:no-repeat;background-size:cover;background-position:center center;">
					...
					<div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0">
						<ul>
							...
							?>
								<li data-index="rs-<?php echo $photo->created_time; ?>" data-transition="incube-horizontal" data-slotamount="1" data-easein="default" data-easeout="default" data-masterspeed="600" data-thumb="<?php echo $image_url; ?>" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="<?php echo $caption_text; ?>" data-param1="<?php echo $photo->created_time; ?>" data-description="">
									<!-- MAIN IMAGE -->
									...
									<!-- LAYER NR. 1 -->
									<a class="tp-caption Instagram-Caption   tp-resizeme" href="<?php echo $photo->link; ?>" target="new" id="slide-<?php echo $photo->created_time; ?>-layer-2" data-x="['left','left','left','left']" data-hoffset="['20','20','20','20']" data-y="['bottom','bottom','bottom','bottom']" data-voffset="['20','20','20','20']" data-width="none" data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;" data-style_hover="cursor:pointer;" data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;s:700;e:Power3.easeInOut;" data-transform_out="y:50px;opacity:0;s:700;e:Power3.easeInOut;s:700;e:Power3.easeInOut;" data-mask_in="x:0px;y:0px;" data-start="0" data-splitin="none" data-splitout="none" data-actions='' data-responsive_offset="on" style="z-index: 5; min-width: auto; min-height: auto; white-space: nowrap; max-width: auto; max-height: auto; font-size: 13px; line-height: 20px; font-weight: 500; color: rgba(255, 255, 255, 1.00);font-family:Roboto;background-color:rgba(0, 0, 0, 0.50);padding:5px 10px 5px 10px;border-radius:0 0 0 0;"><i class="fa-icon-pencil"></i> &nbsp; <?php echo $photo->user->username; ?> &nbsp; &nbsp; <i class="fa-icon-heart"></i> &nbsp; <?php echo $photo->likes->count; ?>
									</a>
								</li>
							<?php endforeach; ?>
						</ul>
