    ...
    <div class="row col-mb-50">
        ...
        <div class="col-12 portfolio-single-image">
            <div class="masonry-thumbs grid-container grid-5" data-big="3" data-lightbox="gallery">
                <a class="grid-item" href="images/portfolio/full/1.jpg" data-lightbox="gallery-item"><img src="{!!asset('webpage/images/portfolio/3/1.jpg" alt="Gallery Thumb 1"></a>
                <a class="grid-item" href="images/portfolio/full/2.jpg" data-lightbox="gallery-item"><img src="{!!asset('webpage/images/portfolio/3/2.jpg" alt="Gallery Thumb 2"></a>
                <a class="grid-item" href="images/portfolio/full/3.jpg" data-lightbox="gallery-item"><img src="{!!asset('webpage/images/portfolio/3/3.jpg" alt="Gallery Thumb 3"></a>
                <a class="grid-item" href="images/portfolio/full/4.jpg" data-lightbox="gallery-item"><img src="{!!asset('webpage/images/portfolio/3/4.jpg" alt="Gallery Thumb 4"></a>
                <a class="grid-item" href="images/portfolio/full/5.jpg" data-lightbox="gallery-item"><img src="{!!asset('webpage/images/portfolio/3/5.jpg" alt="Gallery Thumb 5"></a>
                <a class="grid-item" href="images/portfolio/full/6.jpg" data-lightbox="gallery-item"><img src="{!!asset('webpage/images/portfolio/3/6.jpg" alt="Gallery Thumb 6"></a>
                <a class="grid-item" href="images/portfolio/full/7.jpg" data-lightbox="gallery-item"><img src="{!!asset('webpage/images/portfolio/3/7.jpg" alt="Gallery Thumb 7"></a>
            </div>
