					...
					<ul>
						...
						?>
							<li data-index="rs-<?php echo $photo->id; ?>" data-transition="scaledownfrombottom" data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="1500" data-thumb="<?php echo $photo->url_l; ?>" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="<?php echo $photo->title; ?>" data-param1="<?php echo $photo->datetaken; ?>" data-description="">
								...
								<!-- LAYERS -->
								<!-- LAYER NR. 1 -->
								<a class="tp-caption WebProduct-Menuitem  " href="<?php echo 'https://flic.kr/p/' . TP_flickr::base_encode($photo->id); ?>" target="_blank" id="slide-<?php echo $photo->id; ?>-layer-1" data-x="20" data-y="bottom" data-voffset="20" data-width="['auto']" data-height="['auto']" data-transform_idle="o:1;" data-transform_hover="o:1;rX:0;rY:0;rZ:0;z:0;s:200;e:Linear.easeNone;" data-style_hover="c:rgba(0, 0, 0, 1.00);bg:rgba(255, 255, 255, 1.00);cursor:pointer;" data-transform_in="x:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;s:1500;e:Power3.easeInOut;" data-transform_out="x:[-100%];s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-mask_in="x:0px;y:0px;" data-mask_out="x:inherit;y:inherit;" data-start="0" data-splitin="none" data-splitout="none" data-actions='' data-basealign="slide" data-responsive_offset="on" data-responsive="off" style="z-index: 5; min-width: auto; min-height: auto; white-space: nowrap; max-width: auto; max-height: auto; font-size: 20px; line-height: 30px; font-weight: 500; color: rgba(255, 255, 255, 1.00);font-family:Raleway;background-color:rgba(0, 0, 0, 0.50);padding:3px 5px 3px 8px;border-radius:10px 10px 10px 10px;">
