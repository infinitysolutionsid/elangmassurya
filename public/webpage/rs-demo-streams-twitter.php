			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo" data-dark-logo="images/logo-dark.png')!!}"><img src="{!!asset('webpage/images/logo.png')!!}" alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="images/logo-dark@2x.png')!!}"><img src="{!!asset('webpage/images/logo@2x.png')!!}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
									...
									<div class="top-cart-items">
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{!!asset('webpage/images/shop/small/1.jpg" alt="Blue Round-Neck Tshirt" /></a>
											</div>
										...
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{!!asset('webpage/images/shop/small/6.jpg" alt="Light Blue Denim Dress" /></a>
											</div>
											<div class="top-cart-item-desc">
												<div class="top-cart-item-desc-title">
				...
				<div class="rev_slider_wrapper" style="background-color: #444;">
					...
					<div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0">
						<ul>
							...
							?>
								<!-- SLIDE  -->
								<li data-index="rs-<?php echo $tweet['id']; ?>" data-transition="scaledownfromleft" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="1500" data-thumb="<?php echo $image_url[0]; ?>" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="" data-param1=" <?php echo $tweet["user"]["screen_name"]; ?> - <?php $date = new DateTime($tweet['created_at']);
																																																																																																																																																																																																																						echo $date->format('F d, Y'); ?>" data-param2="<?php echo $tweet['text']; ?>" data-description="">
									<!-- MAIN IMAGE -->
									...
									<!-- LAYER NR. 1 -->
									<!-- TWITTER CONTENT -->
									<div class="tp-caption Twitter-Content  " id="slide-<?php echo $tweet['id']; ?>-layer-6" data-x="10" data-y="bottom" data-voffset="10" data-width="['720']" data-height="['210']" data-transform_idle="o:1;" data-transform_in="y:[110%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;s:2000;e:Power4.easeInOut;" data-transform_out="y:[175%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-start="500" data-splitin="none" data-splitout="none" data-basealign="slide" data-responsive_offset="off" data-end="bytrigger" data-lasttriggerstate="reset" style="z-index: 5; min-width: 720px; min-height: 210px; white-space: normal; max-width: 720px; max-height: 210px; font-size: 26px; line-height: 32px; font-weight: 300; color: rgba(41, 47, 51, 1.00);font-family:Roboto;background-color:rgba(255, 255, 255, 1.00);padding:30px 30px 70px 30px;border-radius:0 0 0 0;"><?php echo TP_twitter::makeClickableLinks($tweet['text']); ?>
									</div>

									<!-- LAYER NR. 2 -->
									<!-- RETWEET INFO -->
									<div class="tp-caption Twitter-Retweet  " id="slide-<?php echo $tweet['id']; ?>-layer-4" data-x="40" data-y="bottom" data-voffset="30" data-width="['auto']" data-height="['auto']" data-transform_idle="o:1;tO:-20% 50%;" data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:2000;e:Power4.easeInOut;" data-transform_out="y:50px;opacity:0;s:500;e:Power1.easeInOut;s:500;e:Power1.easeInOut;" data-start="850" data-splitin="none" data-splitout="none" data-basealign="slide" data-responsive_offset="off" data-responsive="off" data-end="bytrigger" data-lasttriggerstate="reset" style="z-index: 6; min-width: auto; min-height: auto; white-space: nowrap; max-width: auto; max-height: auto; font-size: 15px; line-height: 22px; font-weight: 500; color: rgba(136, 153, 166, 1.00);font-family:Roboto;background-color:rgba(255, 255, 255, 0);border-radius:0 0 0 0;"><i class="icon-twitter"></i> <?php echo $tweet['retweet_count']; ?>
									</div>

									<!-- LAYER NR. 3 -->
									<!-- FAVORITE INFO -->
									<div class="tp-caption Twitter-Favorites  " id="slide-<?php echo $tweet['id']; ?>-layer-1" data-x="115" data-y="bottom" data-voffset="30" data-width="['auto']" data-height="['auto']" data-transform_idle="o:1;tO:-20% 50%;" data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:2000;e:Power4.easeInOut;" data-transform_out="y:50px;opacity:0;s:500;e:Power1.easeInOut;s:500;e:Power1.easeInOut;" data-start="850" data-splitin="none" data-splitout="none" data-basealign="slide" data-responsive_offset="off" data-responsive="off" data-end="bytrigger" data-lasttriggerstate="reset" style="z-index: 7; min-width: auto; min-height: auto; white-space: nowrap; max-width: auto; max-height: auto; font-size: 15px; line-height: 22px; font-weight: 500; color: rgba(136, 153, 166, 1.00);font-family:Roboto;background-color:rgba(255, 255, 255, 0);border-radius:0 0 0 0;"><i class="icon-star3"></i> <?php echo $tweet['favorite_count']; ?>
									</div>

									<!-- LAYER NR. 4 -->
									<!-- LINK TO TWEET -->
									<a class="tp-caption Twitter-Link" href="https://twitter.com/<?php echo $twitter_account; ?>/status/<?php echo $tweet['id']; ?>" target="_blank" id="slide-<?php echo $tweet['id']; ?>-layer-2" data-x="185" data-y="bottom" data-voffset="24" data-width="['auto']" data-height="['auto']" data-transform_idle="o:1;tO:-20% 50%;" data-transform_hover="o:1;rX:0;rY:0;rZ:0;z:0;s:500;e:Power1.easeInOut;" data-style_hover="c:rgba(255, 255, 255, 1.00);bg:rgba(0, 132, 180, 1.00);cursor:pointer;" data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:2000;e:Power4.easeInOut;" data-transform_out="y:50px;opacity:0;s:500;e:Power1.easeInOut;s:500;e:Power1.easeInOut;" data-start="850" data-splitin="none" data-splitout="none" data-actions='' data-basealign="slide" data-responsive_offset="off" data-responsive="off" data-end="bytrigger" data-lasttriggerstate="reset
									data-textAlign=" center"" style="z-index: 8; min-width: auto; min-height: auto; white-space: nowrap; max-width: auto; max-height: auto; font-size: 15px; line-height: 15px; font-weight: 500; color: rgba(135, 153, 165, 1.00);font-family:Roboto;text-align:center;background-color:rgba(255, 255, 255, 1.00);padding:11px 11px 9px 11px;border-radius:30px 30px 30px 30px;"><i class="icon-link"></i>
									</a>

									<!-- LAYER NR. 5 -->
									<!-- LINK TO TWEET HOVER -->
									<div class="tp-caption Twitter-Link  " id="slide-<?php echo $tweet['id']; ?>-layer-8" data-x="10" data-y="10" data-width="['auto']" data-height="['auto']" data-transform_idle="o:1;tO:-20% 50%;" data-transform_hover="o:1;rX:0;rY:0;rZ:0;z:0;s:500;e:Power1.easeInOut;" data-style_hover="c:rgba(255, 255, 255, 1.00);bg:rgba(0, 132, 180, 1.00);br:30px 30px 30px 30px;cursor:pointer;" data-transform_in="opacity:0;s:1500;e:Power3.easeInOut;" data-transform_out="opacity:0;s:1000;e:Power1.easeInOut;s:1000;e:Power1.easeInOut;" data-start="850" data-splitin="none" data-splitout="none" data-actions='[{"event":"click","action":"togglelayer","layerstatus":"visible","layer":"slide-<?php echo $tweet['id']; ?>-layer-6","delay":""},{"event":"click","action":"togglelayer","layerstatus":"visible","layer":"slide-<?php echo $tweet['id']; ?>-layer-4","delay":""},{"event":"click","action":"togglelayer","layerstatus":"visible","layer":"slide-<?php echo $tweet['id']; ?>-layer-1","delay":""},{"event":"click","action":"togglelayer","layerstatus":"visible","layer":"slide-<?php echo $tweet['id']; ?>-layer-2","delay":""}]' data-basealign="slide" data-responsive_offset="off" data-responsive="off" data-textAlign="center" style="z-index: 9; min-width: auto; min-height: auto; white-space: nowrap; max-width: auto; max-height: auto; font-size: 15px; line-height: 15px; font-weight: 500; color: rgba(135, 153, 165, 1.00);font-family:Roboto;text-align:center;background-color:rgba(255, 255, 255, 1.00);padding:10px 11px 9px 11px;border-radius:50px 50px 50px 50px;"><i class="icon-fullscreen"></i>
									</div>
								</li>
							<?php endforeach; ?>
						</ul>
							...
							<div class="row col-mb-50">
								<div class="col-md-4">
									...
									<div class="widget clearfix">
										...
										<img src="{!!asset('webpage/images/footer-widget-logo.png')!!}" alt="Image" class="footer-logo">
				...
				<div class="container">
					...
					<div class="row col-mb-30">
						...
						<div class="col-md-6 text-center text-md-start">
							Copyrights &copy; 2020 All Rights Reserved by Infinity Solutions.<br>
