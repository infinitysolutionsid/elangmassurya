            ...
            <div class="single-post mb-0">
                ...
                <div class="entry clearfix">
                    ...
                    <div class="entry-title">
                        <h2>Rincian Minggu Efektif Tematik Terpadu K13 Edisi Revisi Semester Ganjil</h2>
                    </div><!-- .entry-title end -->
                    ...
                    <div class="entry-image bottommargin">
                        <a href="#"><img src="{!!asset('webpage/demos/course/images/courses/1.jpg')!!}" alt=""></a>
                    </div><!-- .entry-image end -->
                    ...
                    <div class="entry-content mt-0">
                        ...
                        <p><b>Duis mollis, est non commodo luctus</b>, nisi erat porttitor ligula, eget lacinia odio sem
                            nec
...
padding-top: 40px;
                        ...
                        <div class="si-share border-0 d-flex justify-content-between align-items-center">
                            <span>Berikan rating pada ajaran ini:</span>
                ...
                <!-- Post Author Info
						============================================= -->
                <div class="card">
                    <div class="card-header"><strong>Posted by <a href="#">Heri Siregar</a></strong></div>
                    <div class="card-body">
                        <div class="author-image">
                            <img src="{!!asset('webpage/images/author/1.jpg')!!}" alt="Image" class="rounded-circle">
                        </div>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores, eveniet, eligendi et nobis
                        neque minus mollitia sit repudiandae ad repellendus recusandae blanditiis praesentium vitae ab
                        sint earum voluptate velit beatae alias fugit accusantium laboriosam nisi reiciendis deleniti
                        tenetur molestiae maxime id quaerat consequatur fugiat aliquam laborum nam aliquid. Consectetur,
                        perferendis?
                    </div>
