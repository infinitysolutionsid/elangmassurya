                                            ...
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Hi PT. Elang Mas Surya,</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        There are users who ask for
                                                        a
                                                        quotation, here is the
                                                        detailed data we can provide you:
                                                        <br><br>
                                                        Name: {{$getDM['name']}} <br>
                                                        Phone number: {{$getDM['phone']}} <br>
                                                        Email: {{$getDM['email']}} <br>
                                                        Subject: {{$getDM['subject']}} <br>
                                                        What services that he want to know: {{$getDM['services']}} <br>
                                                        Here is the message for you: <br> {!!$getDM['message']!!}
                                                        <br><br>
                                                        <br><br>
                                                        Please help so they get a responsive response so that potential
                                                        customers are happy
                                                    </p>
                                                    <br>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Don't reply this email. <br>
                                                            ...
                                                            Best regards, <br>
                                                            Support System PT. Elang Mas Surya
                                                            <br><br>
                                                            E-mail: <a
                                                                href="mailto:info&#64;elangmassurya.co.id">info&#64;elangmassurya.co.id</a><br>
                                                        </span></p>
                                                </div>
                                            </div>
                                        </div>
