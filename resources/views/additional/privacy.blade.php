        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="terms-title text-center">
                    ...
                    <!-- Title -->
                    <h2 class="h2-md">Privacy Policy</h5>
                ...
                <div class="terms-box mt-60">
                    <p>PT. Elang Mas Surya ( EMS ) is committed to respecting and protecting your privacy. We understand
                        ...
                        you use PT. Elang Mas Surya ( EMS ). By continuing to use or access our applications, you are
                    ...
                    <ol class="simple-list">
                        <li class="list-item"><b>Account Information:</b> By creating an account at Boxity Central
                            ...
                            with other PT. Elang Mas Surya ( EMS ) users. Other information such as e-mail and other
                    ...
                    <p>
                        PT. Elang Mas Surya ( EMS ) uses the information collected on the website for the purpose of: <br>
                    ...
                    <p>
                        PT. Elang Mas Surya ( EMS ) will not provide or distribute users' personal information obtained
                        ...
                        PT. Elang Mas Surya ( EMS ) must respond quickly to all user complaints about the service. If a
                        brief description of the complaint is not sufficient, PT. Elang Mas Surya ( EMS ) will post or
                        display an explanation on the application screen or via email and will plan a system upgrade.
                        <br>
                        PT. Elang Mas Surya ( EMS ) relies on the Criminal Code, the Civil Code, the Law on Consumer
                    ...
                    <p>
                        ...
                        PT. Elang Mas Surya ( EMS ), our customers or others. This includes exchanging information with
                    ...
                    <p>
                        PT. Elang Mas Surya ( EMS ) may change this Privacy Policy to be in line with the development of
                        PT. Elang Mas Surya ( EMS )'s business activities or as required by relevant laws and regulations
                        and government institutions. If PT. Elang Mas Surya ( EMS ) changes this Privacy Policy, Boxity
                        Central Indonesia will notify you via electronic mail (e-mail) or provide a notification on the
                        Application 1 (one) day before the change takes effect. PT. Elang Mas Surya ( EMS ) asks you to
                        review the Application regularly and continuously as long as you use the Application to find out
                        the latest information on how the provisions of this Privacy Policy PT. Elang Mas Surya ( EMS )
                        apply.
                    </p>
                    ...
                    <p>
                        ...
                        of your Personal Information by PT. Elang Mas Surya ( EMS ) as stated in this Privacy Policy.
                        <br><br>
                        PT. Elang Mas Surya ( EMS ) also states that you have the right to provide all the information you
                        have provided to PT. Elang Mas Surya ( EMS ) and to give PT. Elang Mas Surya ( EMS ) the right to
                        process and use and provide information to support and carry out the functions of the
                        Application and release PT. Elang Mas Surya ( EMS ) from all claims. if in the future there is a
                        claim to the invalidity of your right to provide information.

                    </p>
                    <h5 class="h5-xl">How to Contact PT. Elang Mas Surya ( EMS )</h5>
                    <p>
