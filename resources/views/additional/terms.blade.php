        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="terms-title text-center">
                    ...
                    <!-- Title -->
                    <h2 class="h2-md">Our Terms & Conditions</h2>

                    <!-- Text -->
                    <?php $d = date('M d, Y'); ?>
                    <p class="p-xl grey-color">Last Modified: {{$d}}</p>
                ...
                <div class="terms-box mt-60">
                    ...
                    <h5 class="h5-xl"><strong>Content and Intellectual Property Rights</strong></h5>
                    ...
                    <p>The entire content of our Website is the text, graphics, photos, images, logos, artwork and
                        ...
                        Indonesia's express written consent.
                    </p>

                    <h5 class="h5-xl"><strong>Your use of our Website</strong></h5>
                    <p class="p-lg">Our website is a digital engagement platform that allows us to:</p>
                    <ul class="simple-list">
                        <li class="list-item">Provide our service</li>
                        <p>We use your information to provide our services, such as processing terms you search
                            for to display results or helping you share content by suggesting recipients from
                            your contacts.</p>
                        <li class="list-item">Maintain and improve our services
                        </li>
                        <p>
                            We also use your information to make sure our services are working properly, such as
                            tracking or solving problems that you report to us. We use your information to make
                            improvements to our services — for example, understanding which search terms are misspelt
                            most often can help us improve spell check features across our services.
                        </p>
                        <li class="list-item">Developing new services</li>
                        <p>We use the information we collect to help us develop new services. For example, understanding
                            how people update their profiles helps us design and launch Boxity Accounts.</p>
                        <li class="list-item">Provide personalised services, including content</li>
                        <p>We use the information we collect to customise our services to you, including providing
                            recommendations, personalised content and customised search results.</p>
                        <li class="list-item">Measuring performance</li>
                        <p>We use analytical and measurement data to understand how our services are used. For
                            example, we analyse data about your visits to our site to do something like optimise
                            product design.</p>
                        <li class="list-item">Communicating with you</li>
                        <p>We use the information we collect, such as your email address, to interact directly with you.
                        </p>
                        <li class="list-item">Protecting Boxity, our users and the public</li>
                        <p>We use information to help improve the security and reliability of our services. This
                            includes detecting, preventing, and responding to fraud, abuse, security risks, and
                            technical issues that may harm Boxity, our users, or the public.</p>
                    </ul>

                    <p>
                        We use a variety of technologies to process information for this purpose. We use automated
                        systems that analyse your content to provide things like customised search results or other
                        features tailored to how you use our services. And we analyse your content to help us detect
                        abuse such as spam, malware and illegal content. We also use algorithms to recognize patterns in
                        the data. <br><br>
                        We may combine the information we collect on our services across your devices for the purposes
                        described above. Depending on your account settings, your activity on other sites and apps may
                        be associated with personal information to improve Boxity's services. We will seek your consent
                        before using your information for purposes not covered by this Privacy Policy.
                    </p>

                    <h5 class="h5-xl"><strong>Limitation</strong></h5>
                    <p>
                    ...
                    <ol class="simple-list">
                        <li class="list-item">Publish the Website material, in whole or in part in any medium;</li>
                        <li class="list-item">Sell, sublicense and/or commercialise the Website's Website materials, in
                            whole or in part;</li>
                        <li class="list-item">Show and/or display Website Content in public;</li>
                        <li class="list-item">Use this Website in any condition or manner that may damage, disable,
                            overburden or disrupt a server or network;</li>
                        <li class="list-item">Use this Website illegally, including but not limited to hacking, or other
                            means;</li>
                        <li class="list-item">Use this Website contrary to applicable laws and regulations, or in a way
                            that causes, or may cause, harm to the Website, or any person or business entity;</li>
                        <li class="list-item">Engage in data mining, data collection, data mining or other similar
                            activities in connection with this Website, or while using this Website;</li>
                        <li class="list-item">Using automated computer code, processes, programs, robots, net crawlers,
                            spiders, data processing, trawling or alternative computer code, processes, programs or
                            screen scraping systems.</li>
                    ...
                    <p>
                        ...
                        record and store the personal information and data that you provide through the Website from
                        time to time. In
                        principle, we will use your data to provide services to you. Your personal data in Boxity
                    ...
                    <h5 class="h5-xl"><strong>Separation</strong></h5>
                    <p>If any provision of these Terms of Service is deemed unlawful, void or unenforceable, such
                        provision may still be enforced to the extent permitted by applicable law, and the unenforceable
                        portion will be deemed severed from these Terms. Service, such determination shall not affect
